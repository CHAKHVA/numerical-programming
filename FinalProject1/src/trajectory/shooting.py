...
class ShootingMethod:
    """Find optimal shooting parameters using iterative method."""
    ...
    def find_parameters(self) -> tuple[float, float]:
        """Find optimal initial velocity and angle."""
        ...
        # Search ranges
        velocities = np.linspace(np.sqrt(9.81 * distance) * 0.5,
                                 np.sqrt(9.81 * distance) * 1.5, 50)
